...
def test_the_whole_html_digest_for_one_moderator(sends):
    assert sends["digest-cat@example.com"]["html_body"] == (
        ...
        '<p>07-26 08:00 EDT &nbsp; <b>cs.LG</b> cs.AI &nbsp; Pippin Otter &nbsp; submit/123<br>\n'
        '<a href="https://check.arxiv.org/submit/123">A Test Paper on Machine Learning</a><br>\n'
        'Author One, Author Two<br>\n'
        'Proposals: none</p>\n'
        '<p>07-26 07:00 EDT &nbsp; <b>no primary</b> cs.AI cs.LG &nbsp; Pippin Otter &nbsp; submit/124<br>\n'
        '<a href="https://check.arxiv.org/submit/124">Another Test Paper on Category Promotion</a><br>\n'
        'Author Three<br>\n'
        'Proposals: none</p>\n'
        '<h3>Cross Lists:</h3>\n'
